# Generated by Powerlevel10k configuration wizard on 2026-02-20 at 22:49 MSK.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 31091.
# Wizard options: awesome-fontconfig, small icons, unicode, lean_8colors, 1 line,
...
() {
  ...
  # prompt.
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR='d80000'
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    # The color of the filler.
    typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND="d80000"
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND='8b0000'
  # Custom icon.
  # typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='⭐'

  ################################[ prompt_char: prompt symbol ]################################
  # Green prompt symbol if the last command succeeded.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND='d80000'
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND='8b0000'
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND='8b0000'
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND='8b0000'
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%F{#8b0000}'   # default foreground
      local      clean='%F{#8b0000}'  # green foreground
      local   modified='%F{#8b0000}'  # yellow foreground
      local  untracked='%F{#8b0000}'  # blue foreground
      local conflicted='%F{#8b0000}'  # red foreground
    else
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR='#8b0000'
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND='#8b0000'
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND='#8b0000'
  typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND='#8b0000'
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND='d80000'
